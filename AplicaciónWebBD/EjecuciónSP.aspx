...
<body style="height: 583px">
    ...
    <div style="height: 503px; background-color: #FFCC99;">
        ...
        <asp:Button ID="BtnEjecutaFunc" runat="server" OnClick="BtnEjecutaFunc_Click" style="z-index: 1; left: 504px; top: 64px; position: absolute; width: 179px" Text="Ejecución función" />
